 ...
 */
void displayBid(bidInformation bidInfo) {
    cout << "Title: " << bidInfo.Title << endl;
    cout << "Fund: " << bidInfo.Fund << endl;
    cout << "Vehicle: " << bidInfo.ID << endl;
    cout << "Bid Amount: " << bidInfo.Amount << endl;
